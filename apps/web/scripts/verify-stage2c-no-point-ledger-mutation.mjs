/**
 * Stage 2-C — point_ledger / budget mutation must not exist in Stage 2-C code paths
 */
...
for (const dir of STAGE2C_PATHS) {
...
if (failed === 0) {
  console.log("PASS: Stage 2-C paths — no point_ledger/budget mutation or service role");
}
...
console.log("PASS: verify:stage2c-no-point-ledger-mutation");
