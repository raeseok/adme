...
`20260706100700_stage0_f_point_packages_compat_view.sql`
...
### Stage 1 진행: **조건부 가능** (live 검증 PASS 후 최종 승인)

| 쟁점 | 우선순위 | 제안 |
|---|---|---|
| **Docker live 검증 미완료** | **높음** | Docker Desktop 설치 → `scripts/run_live_validation.ps1` |
