...
- Stage 3-D: Production reward open **preflight only**. `ADME_REWARD_KILL_SWITCH` 기본 ON, `ADME_PRODUCTION_REWARD_OPEN` 기본 false, controlled allowlist designed·active=false. Kakao Client Secret rotation attestation이 첫 gate. partner_settlements / cash_out / PASS / 전자금융은 **비범위**
