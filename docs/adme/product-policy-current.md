...
- public route에 `stage3D`/`stage3E`/`stage3F`/`stage3G`/`stage3H`/`stage3HR`/`stage3I`/`stage3J`/`stage3JR` 문자열 자체 노출 금지 — verify public-marker-guard로 검증
